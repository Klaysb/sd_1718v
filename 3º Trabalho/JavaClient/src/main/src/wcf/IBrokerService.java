...
public interface IBrokerService {
    ...
    @RequestWrapper(localName = "StoreData", targetNamespace = "http://tempuri.org/", className = "wcf.StoreData")
    @ResponseWrapper(localName = "StoreDataResponse", targetNamespace = "http://tempuri.org/", className = "wcf.StoreDataResponse")
    ...
    @RequestWrapper(localName = "RetrieveData", targetNamespace = "http://tempuri.org/", className = "wcf.RetrieveData")
    @ResponseWrapper(localName = "RetrieveDataResponse", targetNamespace = "http://tempuri.org/", className = "wcf.RetrieveDataResponse")
    ...
    @RequestWrapper(localName = "DeleteData", targetNamespace = "http://tempuri.org/", className = "wcf.DeleteData")
    @ResponseWrapper(localName = "DeleteDataResponse", targetNamespace = "http://tempuri.org/", className = "wcf.DeleteDataResponse")
